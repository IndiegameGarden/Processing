...
int numberOfCells = 2427; // het aantal blokjes op het scherm
int cellMinimalSize = 3; // minimale grootte van een blokje 
int cellMaximumSize = 18; // maximale grootte van een blokje
float cellMinimalSpeed = 0.01; // minimale snelheid van een blokje
float cellMaximumSpeed = 0.39; // maximale snelheid van een blokje
