...
int numberOfCells = 527; // het aantal blokjes op het scherm
int cellMinimalSize = 1; // minimale grootte van een blokje 
int cellMaximumSize = 9; // maximale grootte van een blokje
float cellMinimalSpeed = 1.01; // minimale snelheid van een blokje
float cellMaximumSpeed = 9.09; // maximale snelheid van een blokje
boolean clearScreen = false; // maak het scherm leeg na elke tekenbeurt
boolean drawRectangles = false; // zet dit op false om cirkels te tekenen
boolean shakyCells = true; // als je dit op true zet krijgen de blokjes Parkinson
...
void setup() {
  size(900, 700); // hoe groot is het scherm?
  background(0.2); // maak de achtergrond voor de eerste keer zwart
